        ...
        textView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    editor.putString("realname", editText1.getText().toString());
                    editor.putString("sex", editText2.getText().toString());
                    editor.putString("age", editText3.getText().toString());
                    editor.putString("idcard", editText8.getText().toString());
                    editor.putString("nation", editText5.getText().toString());
                    editor.putString("school", editText4.getText().toString());
                    editor.putString("specialty", editText6.getText().toString());
                    editor.putString("introduct", editText9.getText().toString());
                    editor.putString("phone", editText7.getText().toString());
                    editor.apply();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
